          ...
          <div className="mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              ...
              <div className="relative group" style={{ width: '430px', height: '480px' }}>
                ...
                <div className="absolute" style={{ top: '16%', left: '16%', right: '16%', bottom: '16%', background: '#e5e5e5' }} />
                {/* Content positioned inside the frame opening */}
                <div className="absolute z-10 flex flex-col items-center justify-center text-center p-4" style={{ top: '16%', left: '16%', right: '16%', bottom: '16%' }}>
